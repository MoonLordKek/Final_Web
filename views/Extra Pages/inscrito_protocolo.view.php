...
<body>
    ...
    <main class="page">
        <section class="py-4 py-xl-5" style="height: 540.781px;">
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div>
                            <h2 class="text-uppercase fw-bold mb-3">YA INSCRIBISTE PROTOCOLO</h2>
                            <p class="mb-4">MANTENTE AL PENDIENTE DE TU CORREO INSTITUCIONAL PARA SABER TU ESTATUS</p>
                        </div>
                    </div>
                    <div class="text-center">
                        <button class="btn btn-primary" onclick="window.location.href = 'index.php';">Regresar</button>
                    </div>
                </div>
            </div>
        </section>
