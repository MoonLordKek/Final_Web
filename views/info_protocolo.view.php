...
<body>
    ...
    <main class="page">
        <section>
            <h2 style="margin: 14px;">Información de Protocolo</h2>
            <div style="margin: 19px;padding: 10px;">
                <div class="row">
                    <div class="col-4 col-sm-3 col-md-3 col-xl-2">
                        <div id="list-example" class="list-group"><a class="list-group-item list-group-item-action" href="#list-item-1">Protocolo</a></div>
                    </div>
                    <div class="col-8 col-sm-9 col-md-9 col-xl-10">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#list-example" data-offset="0" style="overflow: scroll;height: 100vh;">
                            <div id="list-item-1" style="height: 100vh;">
                                <h3>Protocolo</h3>
                                <p class="text-start">El Protocolo de Trabajo Terminal (TT) debe comunicar el objetivo del proyecto, su justificación y alcances. También<br>debe ayudar a designar a los sinodales más adecuados para el TT. Debe redactarse de manera que facilite a los sinodales su evaluación y, eventualmente, servir de guía en la evaluación de TT1 y TT2. También debe ayudar a cualquier lector a comprender claramente la propuesta, su importancia y aplicación. <br><br></p><div>
    <iframe src="https://docdro.id/Kx2jJrT" width="100%" height="500px"></iframe>
</div> 
                                <p class="text-start">Propuestas de Protocolo del semestre actual (2022-2)<br><br></p><div>
