                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php 
                        if(!isset($_SESSION['boleta'])){
                            $messsage = '<li class="nav-item d-xl-flex flex-row justify-content-xl-center"><a class="nav-link" href="login.php" style="color: var(--bs-white);">LOGIN</a><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="fs-3" style="color: rgb(255,255,255);width: 25px;height: 36px;">
                            ...
                            $messsage = '<li class="nav-item d-xl-flex flex-row justify-content-xl-center"><a class="nav-link" href="close_ses.php" style="color: var(--bs-white);">Cerrar sesion</a><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="fs-3" style="color: rgb(255,255,255);width: 25px;height: 36px;">
        ...
        <section class="position-relative py-4 py-xl-5">
            <div class="container position-relative">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12 col-lg-6 col-xl-5 col-xxl-4" style="width: 100%;">
                        <div class="card mb-12">
                            <div class="card-body p-sm-5">
                                <h2 class="text-center mb-4">Registro Protocolo</h2>
                                <form id="formulario" method="POST" action="./protocolo_registro.php">
                                    <div class="mb-3"><input class="form-control" type="text" id="titulo" name="titulo" placeholder="Titulo de TT" required=""></div>
                                    <div class="mb-3"><textarea class="form-control" id="desc" name="desc" rows="6" placeholder="Redacta un resumen de tu TT." required=""></textarea></div>
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            <p>Integrantes del equipo (sin contarte, máximo 4 integrantes y mínimo 3 integrantes)</p>
                                            <input class="form-control" type="text" id="nombre-1" name="nombre-1" style="margin-bottom: 8px;" value="<?php echo $_SESSION['usuario'];?>" disabled>
                                            <input class="form-control" type="text" id="nombre-2" name="nombre-2" style="margin-bottom: 8px;" placeholder="Integrante #2">
                                            <input class="form-control" type="text" id="nombre-3" name="nombre-3" style="margin-bottom: 8px;" placeholder="Integrante #3">
                                            <input class="form-control" type="text" id="nombre-4" name="nombre-4" placeholder="Integrante #4">
                                        </div>
                                        <div class="mb-3">
                                            <p>Boleta de los integrantes del equipo </p>
                                            <input class="form-control" type="text" id="boleta-1" name="boleta-1" style="margin-bottom: 8px;" value="<?php echo $_SESSION['boleta'];?>" disabled>
                                            <input class="form-control" type="text" id="boleta-2" name="boleta-2" style="margin-bottom: 8px;" placeholder="Integrante #2">
                                            <input class="form-control" type="text" id="boleta-3" name="boleta-3" style="margin-bottom: 8px;" placeholder="Integrante #3">
                                            <input class="form-control" type="text" id="boleta-4" name="boleta-4" placeholder="Integrante #4">
                                        </div>
                                    </div>
                                   
                                    <div class="mb-3">
                                        <p>Suba el documento con las <a href="faq.php">especificaciones requeridas</a>.&nbsp;</p><input class="form-control" id="archivo" name="archivo" type="file">
                                    </div></form>
                                    <div><button class="btn btn-primary d-block w-100" onclick="registro_protocolo()">Enviar</button></div>
                            </div>
                        </div>
                    </div>
                </div>
