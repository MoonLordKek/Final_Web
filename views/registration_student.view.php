        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Registro Estudiante</h2>
                    <p>Ingresa tus datos para registrar una cuenta en el sistema.</p>
                </div>
                <form>
                    <div class="mb-3"><label class="form-label" for="name">Nombre</label><input class="form-control item" type="text" id="nombre" required="" placeholder="Juan Augusto Perez"></div>
                    <div class="mb-3"><label class="form-label" for="name">Boleta</label><input class="form-control" id="boleta" placeholder="2021056536"></div>
                    <div class="mb-3"><label class="form-label" for="email">Email</label><input class="form-control item" type="email" id="email" required="" placeholder="jaugustop@alumno.ipn.mx"></div>
                    <div class="mb-3"><label class="form-label" for="password">Contraseña</label><input class="form-control item" type="password" id="password" autocomplete="on" required="" minlength="7" maxlength="40" placeholder="***************"></div>
                    <div class="mb-3"><label class="form-label" for="email">Celular</label><input class="form-control" type="tel" placeholder="55555555" required="" minlength="10" maxlength="10" id="telefono"></div>
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center" style="text-align: center;"><a href="registration_teacher.php" style="margin-left: 0px;margin-top: 29px;width: 279px;">¿Eres profesor? Da click aquí</a></div>
                    <div class="d-xl-flex justify-content-xl-center">
                        <button class="btn btn-primary" id="submit" type="submit" style="margin-top: 13px;width: 131.766px;height: 52px;" onclick="addUsu()">Registrarse</button>
                    </div>
                </form>
            </div>
        </section>
