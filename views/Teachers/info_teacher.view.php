...
<body>
    ...
    <main class="page">
        <section class="clean-block about-us" style="height: 100%;">
            <div class="container" style="margin-top: 14px;">
                <div class="row">
                    <div class="col-md-8 offset-md-0 text-center align-self-center m-auto" style="width: 440px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="fs-1 text-primary">
                        ...
                        <p>NOMBRE:&nbsp;<br>EMAIL:<br>CELULAR:<br><br></p><button class="btn btn-primary" type="button">Actualiza tus datos</button>
                    </div>
                    <div class="col-md-4" style="width: 694px;">
                        <h2>Trabajos Terminales Activos</h2>
                        <div class="card">
                            <div class="card-body d-flex flex-column align-content-stretch justify-content-xl-start align-items-xl-start">
                                <h4 class="card-title" style="width: 271px;">Título de Protocolo</h4>
                                <p class="card-text">Número TT:&nbsp;</p>
                                <p class="card-text">Resumen TT</p>
                                <p class="card-text">Integrantes del Protocolo (3 alumnos y el líder)</p>
                                <p class="card-text">Sinodales</p>
                                <p class="card-text">Directivos</p>
                                <p class="card-text">Rol en el Protocolo: Líder / Integrante / Director / Sinodal</p>
                            </div>
                            <div class="card-body d-flex flex-column align-content-stretch justify-content-xl-start align-items-xl-start">
                                <h4 class="card-title" style="width: 271px;">Título de Protocolo</h4>
                                <p class="card-text">Número TT:&nbsp;</p>
