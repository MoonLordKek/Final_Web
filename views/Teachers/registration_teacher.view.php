        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Registro Profesor</h2>
                    <p>Ingresa tus datos para registrar una cuenta en el sistema.</p>
                </div>
                <form id="form_profe" >
                    <div class="mb-3"><label class="form-label" for="name">Nombre</label>        <input class="form-control item" id="name" name="name" type="text" required="" placeholder="Juan Augusto Perez"></div>
                    <div class="mb-3"><label class="form-label" for="email">Email</label>        <input class="form-control item" id="email" name="email" type="email"  required="" placeholder="jaugustop@profesor.ipn.mx"></div>
                    <div class="mb-3"><label class="form-label" for="password">Contraseña</label><input class="form-control item" id="password" name="password" type="password"  autocomplete="on" required="" minlength="7" maxlength="40" placeholder="***************"></div>
                    <div class="mb-3"><label class="form-label" for="email">Celular</label>      <input class="form-control" type="tel" id="telefono" name="telefono" placeholder="55555555" required="" minlength="10" maxlength="10"></div>
                    <div>
                        <p>En caso de ser externo, suba su CV.</p><input class="form-control" type="file">
                    </div>
                    <div class="d-xl-flex flex-column justify-content-xl-center align-items-xl-center" style="text-align: center;"><button class="btn btn-primary" type="submit" style="margin-top: 13px;width: 131.766px;height: 52px;" id="submit" onclick="addProf()">Registrarse</button></div>
                </form>
            </div>
        </section>
    </main>
