        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form >
                    ...
                    <div class="mb-3"><label class="form-label" for="password">Contraseña</label><input class="form-control" type="password" id="password"></div>
                    ...
                    <a href="registration_student.php" style="margin-left: 27px;">¿No tiene cuenta? De click aquí.</a>
                    <div class="d-xl-flex justify-content-xl-center" style="margin-top: 17px;">
                        <a id="submit" class="btn btn-primary text-center" role="button" onclick="iniciar_Ses()">Iniciar Sesión</a>
                    </div>
                </form>
