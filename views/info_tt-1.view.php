...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-xl-flex flex-row justify-content-xl-center"><a class="nav-link" href="login.php" style="color: var(--bs-white);">LOGIN</a><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="fs-3" style="color: rgb(255,255,255);width: 25px;height: 36px;">
                        ...
                        </svg><a class="nav-link" href="registration_student.php" style="color: var(--bs-white);">registrarse</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page">
        <section>
            <h2 style="margin: 14px;">Información de TT1</h2>
            <div style="margin: 19px;padding: 10px;">
                <div class="row">
                    <div class="col-4 col-sm-3 col-md-3 col-xl-2">
                        <div id="list-example" class="list-group"><a class="list-group-item list-group-item-action" href="#list-item-1">TT1</a></div>
                    </div>
                    <div class="col-8 col-sm-9 col-md-9 col-xl-10">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#list-example" data-offset="0" style="overflow: scroll;height: 100vh;">
                            <div id="list-item-1" style="height: 100vh;">
                                <h3>Trabajo Terminal 1</h3>
                                <p class="text-start">Una vez aprobado el Protocolo, el siguiente paso es cursar la&nbsp; Trabajo Terminal 1, en la cual el proyecto iniciará a trabajarse con los integrantes. Su proceso se mide a final de semestre, donde se presentan los avances y futuros objetivos del proyecto.<br><br></p>
                                <p class="text-start">Aqui se podra encontrar el formato con el cual se presentara el reporte tecnico del TT y un ejemplo<br><br></p><div>
    <iframe src="https://docdro.id/1EAtuE3" width="100%" height="500px"></iframe>
</div> <div>
    <iframe src="https://docdro.id/nbSXSVM" width="100%" height="500px"></iframe>
</div> 
                                <p class="text-start">Calendario de presentaciones de TT 1</p><div>
    <iframe src="https://docdro.id/SkUxbkO" width="100%" height="500px"></iframe>
</div>
                                <p class="text-start">Si necesita reprogramar una fecha para la presentación, llene el siguiente formato:</p><div>
    <iframe src="https://docdro.id/SknyaTe" width="100%" height="500px"></iframe>
</div>
                            </div>
                        </div>
                    </div>
