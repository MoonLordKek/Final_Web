...
<body>
    ...
    <main class="page">
        <section>
            <h2 style="margin: 14px;">Información de TT2</h2>
            <div style="margin: 19px;padding: 10px;">
                <div class="row">
                    <div class="col-4 col-sm-3 col-md-3 col-xl-2">
                        <div id="list-example" class="list-group"><a class="list-group-item list-group-item-action" href="#list-item-1">TT2</a></div>
                    </div>
                    <div class="col-8 col-sm-9 col-md-9 col-xl-10">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#list-example" data-offset="0" style="overflow: scroll;height: 100vh;">
                            <div id="list-item-1" style="height: 100vh;">
                                <h3>Trabajo Terminal 2</h3>
                                <p class="text-start">El Trabajo Terminal 2 es el último paso para concluir el Trabajo Terminal. Aquí se presentan los objetivos alcanzados y el proyecto totalmente concluido en una presentación especial con los sinodales y directivos del proyecto.<br><br></p>
                                <p class="text-start">Seguimiento de TT2</p><div>
    <iframe src="https://docdro.id/Kx2jJrT" width="100%" height="500px"></iframe>
</div> 
                                <p class="text-start">Después de la entrega del último reporte técnico se elabora el siguiente acuse<br><br></p><div>
    <iframe src="https://docdro.id/HiiLNMJ" width="100%" height="500px"></iframe>
</div>
                                <p class="text-start">Carta responsiva</p><div>
    <iframe src="https://docdro.id/HiiLNMJ" width="100%" height="500px"></iframe>
</div>
                                <p class="text-start">Formato de disco de entrega</p><div>
    <iframe src="https://docdro.id/HiiLNMJ" width="100%" height="500px"></iframe>
</div>
                                <p class="text-start">Extraordinario</p><div>
    <iframe src="https://docdro.id/HiiLNMJ" width="100%" height="500px"></iframe>
</div>
                            </div>
                        </div>
